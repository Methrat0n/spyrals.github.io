...
const figuresStyleVerso = "flex flex-col rounded-xl h-[29rem] w-[21rem] min-w-[21rem] z-10"
...
const Merlin = () =>
  <div className='flip-card h-[29rem] w-[21rem] min-w-[21rem] z-10 focus:-z-10 mx-2' tabIndex={1}>
    <div className='flip-card-inner'>
      ...
      <div className={`${figuresStyleVerso} from-purple-dark to-[#2E0237] bg-gradient-to-br relative overflow-y-clip flip-card-back`}>
...
const Mallorie = () =>
  <div className='flip-card h-[29rem] w-[21rem] min-w-[21rem] z-10 focus:-z-10 mx-2' tabIndex={2}>
    <div className='flip-card-inner'>
      ...
      <div className={`${figuresStyleVerso} from-[#FF03EE] to-[#880C85] bg-gradient-to-br relative overflow-y-clip flip-card-back`}>
...
const Julien = () =>
  <div className='flip-card h-[29rem] w-[21rem] min-w-[21rem] z-10 focus:-z-10 mx-2' tabIndex={3}>
    <div className='flip-card-inner'>
      ...
      <div className={`${figuresStyleVerso} from-[#8C53FF] to-[#051133] bg-gradient-to-br relative overflow-y-clip flip-card-back`}>
...
const Fabien = () =>
  <div className='flip-card h-[29rem] w-[21rem] min-w-[21rem] z-10 focus:-z-10 mx-2' tabIndex={4}>
    <div className='flip-card-inner'>
      ...
      <div className={`${figuresStyleVerso} from-[#FFBD59] to-[#D16023] bg-gradient-to-br relative overflow-y-clip flip-card-back`}>
