...
export default () =>
  <section className="flex flex-col items-center pt-24 sm:ml-32 overflow-x-hidden" id='worklife'>
...
const Gallery = () =>
  <div className="flex flex-row overflow-auto py-20 pl-28 sm:pl-4 hide-scroll">
