...
const SpyralsLeft = () =>
  <div className="flex flex-col items-center md:justify-start lg:justify-center max-md:w-full md:mr-10 lg:mr-20 lg:mx-20">
    ...
    <div className="flex flex-wrap sm:flex-row justify-between -mt-8 md:mt-0 text-2xl lg:text-3xl pt-10 pb-8 md:pl-8 lg:pl-40 font-semibold max-md:self-end text-right">
