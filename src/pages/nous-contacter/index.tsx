...
const ContactLeft = () =>
  <div className='flex flex-col items-center min-w-0 md:min-w-[20rem] md:w-[20rem] lg:min-w-[37rem] lg:w-[37rem] md:items-start md:mr-5 relative'>
    ...
    <BordedPicture sizes='h-80 min-w-[33rem] md:h-44 md:min-w-[18rem]' positioning='-rotate-[9deg] translate-x-16 self-end z-20 mt-[18rem]' className='border-yellow hidden md:block' src={config.img_path + config.contactForm.img} alt={config.contactForm.img_alt} />
