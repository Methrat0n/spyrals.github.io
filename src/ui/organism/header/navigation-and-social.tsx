...
export default () =>
  <div className="flex flex-row-reverse sm:flex-row justify-between w-5/12 h-full items-center">
    <Navigation />
    <Socials />
    <FixedMobile />
  </div>
...
const Navigation = () =>
  <div className="hidden sm:flex w-full justify-evenly items-center pt-6">
