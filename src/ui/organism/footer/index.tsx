...
export default () =>
  <footer className="flex flex-row justify-between border-t-2 border-purple-600 items-center h-24 mx-1 md:mx-8 text-white">
    <SpyralsLogoFooter />
    <div className='flex flex-wrap items-center justify-end md:grow md:justify-around max-md:pt-5 mt-[1.1rem]'>
      <FollowSocials />
      <PhoneContact />
      <div className='flex flex-row justify-around md:w-1/4 mx-1'>
